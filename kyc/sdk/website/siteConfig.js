...
const siteConfig = {
  ...
  baseUrl: '/kyc/docs/sdk/' /* base url for your project */,
  projectName: 'sdk',
  ...
  headerLinks: [
    ...
    {href: "/kyc/docs/", label: 'KYC'},
    {href: 'https://help.ost.com/support/home', external: true,  label: 'Support'}
  ],

  secondryHeaderLinks: [
  {href: '/kyc/docs/getting_started/overview', label: 'Docs'},
  {href: '/kyc/docs/api', label: 'API'},
  {href: '/kyc/docs/sdk', label: 'SDK'},
