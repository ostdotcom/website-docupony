...
| _uuid_            | String | The unique identifier of your application’s end-user, generated by [Create User API](https://dev.stagingost.com/test-site/docs/user.html#1create-a-new-user-api) |
