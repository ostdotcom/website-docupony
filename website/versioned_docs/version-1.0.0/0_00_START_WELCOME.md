...
* [<u>Setup transaction types</u>](/docs/api_actions_create.html) for your Branded Token that are user-to-user, company-to-user, and user-to-company
* [<u>Define transactions in fiat value</u>](/docs/api_actions_create.html) that use the OST Price Oracle to automatically adjust the price of your Branded Token
...
* [<u>Airdrop</u>](/docs/api_airdrop_drop.html) Branded Tokens to selected users
* [<u>Execute transactions</u>](/docs/api_transaction-types_execute.html) 
