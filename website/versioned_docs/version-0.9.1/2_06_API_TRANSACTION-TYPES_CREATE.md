...
| _commission_percent_| float  | inclusive percentage of the value that is sent to company. Including _commission_percent_ for either _user_to_company_ or _company_to_user_ action types will result in an error. (min 0%, max 100%) |
