...
* Integrate one of the available OST Platform Server SDK into your application. SDKs are available for [PHP](/platform/docs/server_sdk_setup/php/), [Ruby](https://github.com/ostdotcom/ost-sdk-ruby), [Node.Js](https://github.com/ostdotcom/ost-sdk-js) and [Java](https://github.com/ostdotcom/ost-sdk-java).
...
### Register Device
Your server should receive the device information from your mobile app. To register the device on OST Platform you can use the devices service provided in the Server Side SDKs (available in [PHP](/platform/docs/server_sdk_setup/php/), [Ruby]((https://github.com/ostdotcom/ost-sdk-ruby)), [Java](https://github.com/ostdotcom/ost-sdk-java), [Node.Js](https://github.com/ostdotcom/ost-sdk-js)).
