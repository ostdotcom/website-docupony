...
## 1. Prerequisite 
You will need to integrate server side SDK on your server. You can use one of the available server side sdk: [PHP](/platform/sdkserver_sdk_setup/php/), [Ruby](/platform/sdkserver_sdk_setup/ruby/), [Java](/platform/sdkserver_sdk_setup/java/), [Node.js](/platform/sdkserver_sdk_setup/nodejs/).
...
![copy-framework-file](/platform/sdkassets/copy-framework-file.png)
...
![copy-framework-file](/platform/sdkassets/add-dependency-framework-files.png)
...
![walletSDKCommunication](/platform/sdkassets/communication-ios-sdk.png)
...
3. iOS Wallet SDK [Methods](/platform/sdkreferences/wallet_sdk/iOS/latest/methods/),  [Protocol](/platform/sdkreferences/wallet_sdk/iOS/latest/protocols/) and [Classes](/platform/sdkreferences/wallet_sdk/iOS/latest/classes/)
